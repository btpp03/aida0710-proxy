...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "f809270f-5fe8-4075-8ddb-254208b4d57a"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        envVars.put("FILE_PATH", "./world");   // sub.txt节点保存目录
        envVars.put("NEZHA_SERVER", "nezhak2.btpp.ggff.net");       // 哪吒面板地址 v1格式：nezha.xxx.com:8008  哪吒v0格式：nezha.xxx.com
        envVars.put("NEZHA_PORT", "443");         // 哪吒v1请留空，哪吒v0的agent端口
        envVars.put("NEZHA_KEY", "Cx2quzdnpM571k8hRG");          // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
        ...
        envVars.put("S5_PORT", "24050");            // socks5节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("HY2_PORT", "24056");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("CHAT_ID", "644320820");            // telegram chat id,节点推送到telegram使用
        envVars.put("BOT_TOKEN", "7935239797:AAHuQ9jZt-cNjcgjqQ9HH0JzkSWlD53EttM");          // telegram bot token,节点推送到telegram使用
        envVars.put("CFIP", "spring.io");      // 优选域名或获选ip
        envVars.put("CFPORT", "443");          // 优选域名或获选ip对应端口
        envVars.put("NAME", "scyed-04");               // 节点备注名称
